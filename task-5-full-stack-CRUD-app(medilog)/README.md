...
A full-stack CRUD application for managing patient records in a clinical environment. MediLog allows healthcare staff to register patients, track their status, update conditions, and maintain a digital ward record system.
...
1. **Register a Patient**: Fill out the Patient Intake form on the left and click **Register Patient**.
2. **View Records**: All patients appear in the Current Ward Records section.
3. **Update Status**: Click the status badge on any patient card to toggle between "Admitted" and "Recovered".
4. **Delete Record**: Click the trash icon to permanently remove a patient record.
